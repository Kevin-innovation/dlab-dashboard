...
export class StatisticsCalculator {
  ...
  static generateStatisticsSummary(
    ...
    const studentChange = {
      ...
      percentage:
        previousPeriodStats.actual_students > 0
          ? ((currentPeriodStats.actual_students - previousPeriodStats.actual_students) /
              previousPeriodStats.actual_students) *
            100
          : 0,
    }
    ...
    const currentRevenue =
      'weekly_revenue' in currentPeriodStats
        ? currentPeriodStats.weekly_revenue
        : currentPeriodStats.total_revenue
    const previousRevenue =
      'weekly_revenue' in previousPeriodStats
